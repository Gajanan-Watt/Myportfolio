    ...
    <div className={styles.rootCont} id="hero">
      <Fade>
        <div className={styles.nameCont}>
          <p>Hi,</p>
          <p>
            I am <span>Gajanan</span>{" "}
          </p>
          <p>Web Developer</p>
          <a
//             href="https://drive.google.com/file/d/1lpH1liTLMq8pK2SRaM9MW808MqazsG2k/view?usp=sharing"
            href="https://drive.google.com/file/d/1O-ezbVnSKr4slp7Trc2VsCPCStkN_j9D/view?usp=share_link"
            target="_blank"
        ...
        <div className={styles.socialCont}>
          ...
          <a
            rel="noreferrer"
            href="https://github.com/Gajanan-Watt"
            className={classes.a}
            target="_blank"
          >
